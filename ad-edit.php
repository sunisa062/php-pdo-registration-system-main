...
/*มีการเก็บ session*/
    ...
    $sql = $conn->prepare("UPDATE chap SET img = :img, title = :title WHERE id = :id");
    $sql->bindParam(":id", $id);
...
<body>
    ...
    <div class="container mt-5">
        <h1>Edit</h1>
        <hr>
        <form action="ad-edit.php" method="post" enctype="multipart/form-data"><!--มีการเพิ่มรูปภาพ จึงต้องมี enctype="multipart/form-data" เพื่อให้ insert ได้-->
            <?php
            if (isset($_GET['id'])) {
                $id = $_GET['id'];
